...
$request4 = '{"questions":[{"question_id":"41","answer_text":"def whileTest(n):\n\tg=\'\'\n\twhile(n>0):\n\t\tg+=\'a\'\n\t\tn-=1\n\treturn g"},{"question_id":"47","answer_text":"def whileTest2(n):\n\treturn(n*\'a\')"}],"request":"submit_graded_test","test_id":"112","sessionid":"ec4daa568589db9919775145f8cb36a2b6ae144f","student_token":"ec4daa568589db9919775145f8cb36a2b6ae144f"}';
...
die();
*/
echo "Posting to MG...".PHP_EOL;
$sample_POST = /*["request"=>$request4];//*/["request"=>json_encode($request5)];
$time = time();
